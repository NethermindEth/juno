...
// #cgo vm_debug LDFLAGS:  -L./rust/target/debug -ljuno_starknet_core_rs -lm -ldl -framework Foundation -framework SystemConfiguration
// #cgo !vm_debug LDFLAGS: -L./rust/target/release -ljuno_starknet_core_rs -lm -ldl -framework Foundation -framework SystemConfiguration
import "C"
