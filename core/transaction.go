...
type ResourceBounds struct {
	MaxAmount uint64 `cbor:"1,keyasint"`
	// MaxPricePerUnit is technically a uint128
	MaxPricePerUnit *felt.Felt `cbor:"2,keyasint"`
}
...
type Event struct {
	Data []*felt.Felt `cbor:"1,keyasint"`
	From *felt.Felt   `cbor:"2,keyasint"`
	Keys []*felt.Felt `cbor:"3,keyasint"`
}

type L1ToL2Message struct {
	From     common.Address `cbor:"1,keyasint"`
	Nonce    *felt.Felt     `cbor:"2,keyasint"`
	Payload  []*felt.Felt   `cbor:"3,keyasint"`
	Selector *felt.Felt     `cbor:"4,keyasint"`
	To       *felt.Felt     `cbor:"5,keyasint"`
}

type L2ToL1Message struct {
	From    *felt.Felt     `cbor:"1,keyasint"`
	Payload []*felt.Felt   `cbor:"2,keyasint"`
	To      common.Address `cbor:"3,keyasint"`
}

type ExecutionResources struct {
	BuiltinInstanceCounter BuiltinInstanceCounter `cbor:"1,keyasint"`
	MemoryHoles            uint64                 `cbor:"2,keyasint"`
	Steps                  uint64                 `cbor:"3,keyasint"`
	DataAvailability       *DataAvailability      `cbor:"4,keyasint"`
	TotalGasConsumed       *GasConsumed           `cbor:"5,keyasint"`
}
...
type BuiltinInstanceCounter struct {
	Pedersen     uint64 `cbor:"1,keyasint"`
	RangeCheck   uint64 `cbor:"2,keyasint"`
	Bitwise      uint64 `cbor:"3,keyasint"`
	Output       uint64 `cbor:"4,keyasint"`
	Ecsda        uint64 `cbor:"5,keyasint"`
	EcOp         uint64 `cbor:"6,keyasint"`
	Keccak       uint64 `cbor:"7,keyasint"`
	Poseidon     uint64 `cbor:"8,keyasint"`
	SegmentArena uint64 `cbor:"9,keyasint"`
	AddMod       uint64 `cbor:"10,keyasint"`
	MulMod       uint64 `cbor:"11,keyasint"`
	RangeCheck96 uint64 `cbor:"12,keyasint"`
}
...
type DeployTransaction struct {
	TransactionHash *felt.Felt `cbor:"1,keyasint"`
	// A random number used to distinguish between different instances of the contract.
	ContractAddressSalt *felt.Felt `cbor:"2,keyasint"`
	// The address of the contract.
	ContractAddress *felt.Felt `cbor:"3,keyasint"`
	// The hash of the class which defines the contract’s functionality.
	ClassHash *felt.Felt `cbor:"4,keyasint"`
	// The arguments passed to the constructor during deployment.
	ConstructorCallData []*felt.Felt `cbor:"5,keyasint"`
	...
	Version *TransactionVersion `cbor:"6,keyasint"`
}
...
type DeployAccountTransaction struct {
	...
	MaxFee *felt.Felt `cbor:"7,keyasint"`
	// Additional information given by the sender, used to validate the transaction.
	TransactionSignature []*felt.Felt `cbor:"8,keyasint"`
	// The transaction nonce.
	Nonce *felt.Felt `cbor:"9,keyasint"`

	// Version 3 fields
	// See InvokeTransaction for descriptions of the fields.
	ResourceBounds map[Resource]ResourceBounds `cbor:"10,keyasint"`
	Tip            uint64                      `cbor:"11,keyasint"`
	PaymasterData  []*felt.Felt                `cbor:"12,keyasint"`
	NonceDAMode    DataAvailabilityMode        `cbor:"13,keyasint"`
	FeeDAMode      DataAvailabilityMode        `cbor:"14,keyasint"`
}
...
type InvokeTransaction struct {
	...
	CallData []*felt.Felt `cbor:"2,keyasint"`
	// Additional information given by the sender, used to validate the transaction.
	TransactionSignature []*felt.Felt `cbor:"3,keyasint"`
	// The maximum fee that the sender is willing to pay for the transaction
	// Available in version 1 only
	MaxFee *felt.Felt `cbor:"4,keyasint"`
	// The address of the contract invoked by this transaction.
	ContractAddress *felt.Felt `cbor:"5,keyasint"`
	// When the fields that comprise a transaction change,
	// either with the addition of a new field or the removal of an existing field,
	// then the transaction version increases.
	Version *TransactionVersion `cbor:"6,keyasint"`
	...
	EntryPointSelector *felt.Felt `cbor:"7,keyasint"`

	// Version 1 fields
	// The transaction nonce.
	Nonce *felt.Felt `cbor:"8,keyasint"`
	// The address of the sender of this transaction
	SenderAddress *felt.Felt `cbor:"9,keyasint"`
...
type DeclareTransaction struct {
	TransactionHash *felt.Felt `cbor:"1,keyasint"`
	// The class hash
	ClassHash *felt.Felt `cbor:"2,keyasint"`
	// The address of the account initiating the transaction.
	SenderAddress *felt.Felt `cbor:"3,keyasint"`
	// The maximum fee that the sender is willing to pay for the transaction.
	// Available in versions 1, 2
	MaxFee *felt.Felt `cbor:"4,keyasint"`
	// Additional information given by the sender, used to validate the transaction.
	TransactionSignature []*felt.Felt `cbor:"5,keyasint"`
	// The transaction nonce.
	Nonce *felt.Felt `cbor:"6,keyasint"`
	// The transaction’s version. Possible values are 0, 1, 2, or 3.
	// When the fields that comprise a transaction change,
	// either with the addition of a new field or the removal of an existing field,
	// then the transaction version increases.
	// Transaction version 0 is deprecated and will be removed in a future version of Starknet.
	Version *TransactionVersion `cbor:"7,keyasint"`

	// Version 2 fields
	CompiledClassHash *felt.Felt `cbor:"8,keyasint"`

	// Version 3 fields
	// See InvokeTransaction for descriptions of the fields.
	ResourceBounds        map[Resource]ResourceBounds `cbor:"9,keyasint"`
	Tip                   uint64                      `cbor:"10,keyasint"`
	PaymasterData         []*felt.Felt                `cbor:"11,keyasint"`
	AccountDeploymentData []*felt.Felt                `cbor:"12,keyasint"`
	NonceDAMode           DataAvailabilityMode        `cbor:"13,keyasint"`
	FeeDAMode             DataAvailabilityMode        `cbor:"14,keyasint"`
}
...
type L1HandlerTransaction struct {
	TransactionHash *felt.Felt `cbor:"1,keyasint"`
	// The address of the contract.
	ContractAddress *felt.Felt `cbor:"2,keyasint"`
	// The encoding of the selector for the function invoked (the entry point in the contract)
	EntryPointSelector *felt.Felt `cbor:"3,keyasint"`
	// The transaction nonce.
	Nonce *felt.Felt `cbor:"4,keyasint"`
	// The arguments that are passed to the validated and execute functions.
	CallData []*felt.Felt `cbor:"5,keyasint"`
	// When the fields that comprise a transaction change,
	// either with the addition of a new field or the removal of an existing field,
	// then the transaction version increases.
	Version *TransactionVersion `cbor:"6,keyasint"`
