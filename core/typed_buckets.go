...
// Bucket 2: Contract class (Felt) -> Contract class hash (Felt)
...
// Bucket 4: Class hash (Felt) -> Class definition (DeclaredClassDefinition)
// TODO: Integrate this bucket
...
// Bucket 5: Contract address (Felt) -> Contract nonce (Felt)
// TODO: Integrate this bucket
...
// Bucket 9: Transaction hash (Felt) -> Block number and index (BlockNumIndexKey)
// TODO: Integrate this bucket
...
var TransactionsByBlockNumberAndIndexBucket = prefix.NewPrefixedBucket(
	...
	prefix.Prefix(key.Uint64, prefix.Prefix(key.Uint64, prefix.End[db.BlockNumIndexKey]())),
)
...
// Bucket 17: Contract address (Felt) -> Deployment height (uint64)
// TODO: Integrate this bucket
...
// Bucket 39: Class hash (Felt) -> CASM hash (Felt)
