...
// BlockHash assumes block.SequencerAddress is not nil assuming this is called with post v0.12.0
// Starknet which resolved the unverifiable block hash issues.
