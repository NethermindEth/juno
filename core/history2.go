...
func (h *history2) logOldValue(key, value []byte, height uint64) error {
	return h.txn.Put(logDBKey(key, height), value)
}

func (h *history2) deleteLog(key []byte, height uint64) error {
	return h.txn.Delete(logDBKey(key, height))
}

func (h *history2) valueAt(key []byte, height uint64) ([]byte, error) {
...
func (h *history2) LogContractStorage(contractAddress, storageLocation, oldValue *felt.Felt, height uint64) error {
...
func (h *history2) DeleteContractStorageLog(contractAddress, storageLocation *felt.Felt, height uint64) error {
...
func (h *history2) ContractStorageAt(contractAddress, storageLocation *felt.Felt, height uint64) (*felt.Felt, error) {
	key := storageLogKey(contractAddress, storageLocation)
...
func (h *history2) LogContractNonce(contractAddress, oldValue *felt.Felt, height uint64) error {
	return h.logOldValue(nonceLogKey(contractAddress), oldValue.Marshal(), height)
}

func (h *history2) DeleteContractNonceLog(contractAddress *felt.Felt, height uint64) error {
	return h.deleteLog(nonceLogKey(contractAddress), height)
}

func (h *history2) ContractNonceAt(contractAddress *felt.Felt, height uint64) (*felt.Felt, error) {
...
func (h *history2) LogContractClassHash(contractAddress, oldValue *felt.Felt, height uint64) error {
	return h.logOldValue(classHashLogKey(contractAddress), oldValue.Marshal(), height)
}

func (h *history2) DeleteContractClassHashLog(contractAddress *felt.Felt, height uint64) error {
	return h.deleteLog(classHashLogKey(contractAddress), height)
}

func (h *history2) ContractClassHashAt(contractAddress *felt.Felt, height uint64) (*felt.Felt, error) {
