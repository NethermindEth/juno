...
func TestGenerateClass(t *testing.T) {
	...
	contractDefinition, err := os.ReadFile("fixtures/contract_definition.json")
	if err != nil {
...
func TestClassHash(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			file: "fixtures/contract_definition.json", // Cairo 0.10
		},
		{
			...
			file: "fixtures/genesis_contract.json", // Genesis contract
		},
		{
			...
			file: "fixtures/contract_0_8.json", // Cairo 0.8
		},
	}
