...
func TestPoseidon(t *testing.T) {
	...
	assert.Equal(t, "5d44a3decb2b2e0cc71071f7b802f45dd792d064f0fc7316c46514f70f9891a",
		crypto.Poseidon(left, right).Text(16))
}
...
func TestPoseidonArray(t *testing.T) {
	for name, test := range map[string]struct {
		...
		"empty array": {
			elems:    []*felt.Felt{},
			expected: "2272be0f580fd156823304800919530eaa97430e972d7213ee13f4fbf7a5dbc",
		},
		"odd elems": {
			elems: []*felt.Felt{
			...
			expected: "7a01142da8aecae3782ba66fc3285fd02fcd2c55aa868fe50fd95c089068d16",
		},
		"even elems": {
			elems: []*felt.Felt{
				new(felt.Felt), new(felt.Felt).SetUint64(1),
			...
			expected: "7b8f30ac298ea12d170c0873f1fa631a18c00756c6e7d1fd273b9a239d0d413",
		},
	} {
		t.Run(name, func(t *testing.T) {
			assert.Equal(t, test.expected, crypto.PoseidonArray(test.elems...).Text(16))
		})
	}
}
