...
func TestClass(t *testing.T) {
	...
	cairo0Hash := felt.NewUnsafeFromString[felt.Felt]("0x4631b6b3fa31e140524b7d21ba784cea223e618bffe60b5bbdca44a8b45be04")
...
func setupState(t *testing.T, stateUpdates []*core.StateUpdate, blocks uint64) *StateDB {
	...
	for i, su := range stateUpdates[:blocks] {
		...
		require.NoError(t, state.Update(uint64(i), su, declaredClasses, false), "failed to update state for block %d", i)
