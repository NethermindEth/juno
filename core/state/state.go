...
// TODO: copy the actual values from deprecatedstate when we remove it
//
...
var (
	SystemContract1Address = deprecatedstate.SystemContract1Address
	// https://community.starknet.io/t/starknet-v0-13-4-pre-release-notes/115257#p-2358763-stateful-compression-11
	SystemContract2Address   = deprecatedstate.SystemContract2Address
	SystemContractsClassHash = deprecatedstate.SystemContractsClassHash
	SystemContracts          = deprecatedstate.SystemContracts
)
