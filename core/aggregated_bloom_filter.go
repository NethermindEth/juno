...
var (
	...
	// Returned by UnmarshalBinary and BlocksForKeysInto for a corrupt blob.
	ErrBloomFilterHeaderTooShort       error = errors.New("bloom filter header too short")
	ErrBloomFilterRowCountMismatch     error = errors.New("bloom filter row count mismatch")
	ErrBloomFilterLenMismatch          error = errors.New("bloom filter blob len mismatch")
	ErrBloomFilterRangeMismatch        error = errors.New("bloom filter block range mismatch")
	ErrBloomFilterRowBlobLenMismatch   error = errors.New("bloom filter row blob len mismatch")
	ErrBloomFilterRowBitsetLenMismatch error = errors.New("bloom filter row bitset len mismatch")
)
