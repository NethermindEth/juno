...
type MockStateMachine[V tendermint.Hashable[H], H tendermint.Hash, A tendermint.Addr] struct {
...
type MockStateMachineMockRecorder[V tendermint.Hashable[H], H tendermint.Hash, A tendermint.Addr] struct {
	mock *MockStateMachine[V, H, A]
}

// NewMockStateMachine creates a new mock instance.
func NewMockStateMachine[V tendermint.Hashable[H], H tendermint.Hash, A tendermint.Addr](ctrl *gomock.Controller) *MockStateMachine[V, H, A] {
...
func (m *MockStateMachine[V, H, A]) ProcessPrecommit(arg0 tendermint.Precommit[H, A]) []tendermint.Action[V, H, A] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessPrecommit", arg0)
	ret0, _ := ret[0].([]tendermint.Action[V, H, A])
	return ret0
}
...
func (m *MockStateMachine[V, H, A]) ProcessPrevote(arg0 tendermint.Prevote[H, A]) []tendermint.Action[V, H, A] {
	m.ctrl.T.Helper()
...
func (m *MockStateMachine[V, H, A]) ProcessProposal(arg0 tendermint.Proposal[V, H, A]) []tendermint.Action[V, H, A] {
	m.ctrl.T.Helper()
...
func (m *MockStateMachine[V, H, A]) ProcessStart(arg0 tendermint.Round) []tendermint.Action[V, H, A] {
	m.ctrl.T.Helper()
...
func (m *MockStateMachine[V, H, A]) ProcessTimeout(arg0 tendermint.Timeout) []tendermint.Action[V, H, A] {
	m.ctrl.T.Helper()
