...
func (wal *BaseWAL) Write(msg WALMessage) error {
	...
	if err := wal.enc.Encode(&TimedWALMessage{utils.Now(), msg}); err != nil {
...
func (enc *WALEncoder) Encode(v *TimedWALMessage) error {
	...
	if err != nil {
		return fmt.Errorf("encode timed wall message failure: %w", err)
	}
...
func (dec *WALDecoder) Decode() (*TimedWALMessage, error) {
	...
	res := new(tmproto.TimedWALMessage)
