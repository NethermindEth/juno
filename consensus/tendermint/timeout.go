...
func (s *stateMachine[V, H, A]) onTimeoutPropose(h types.Height, r types.Round) types.Action[V, H, A] {
...
func (s *stateMachine[V, H, A]) onTimeoutPrevote(h types.Height, r types.Round) types.Action[V, H, A] {
...
func (s *stateMachine[V, H, A]) onTimeoutPrecommit(h types.Height, r types.Round) types.Action[V, H, A] {
