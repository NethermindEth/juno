...
func getBlockchain(t *testing.T, genesisDiff core.StateDiff, genesisClasses map[felt.Felt]core.ClassDefinition) *blockchain.Blockchain {
	t.Helper()
	testDB := memory.New()
	network := &utils.Mainnet
...
func loadGenesis(t *testing.T, log *utils.ZapLogger) (core.StateDiff, map[felt.Felt]core.ClassDefinition) {
	t.Helper()
