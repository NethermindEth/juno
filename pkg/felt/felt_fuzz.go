...
func Fuzz(data []byte) int {
...

	{
		...
		if !c.Equal(&_c) {
			panic("mul asm != mul generic on Felt")
		}
	}
...
eof:
	...
	if z.BiggerModulus() {
		var b uint64
		z[0], b = bits.Sub64(z[0], qFelt[0], 0)
		z[1], b = bits.Sub64(z[1], qFelt[1], b)
		z[2], b = bits.Sub64(z[2], qFelt[2], b)
		z[3], b = bits.Sub64(z[3], qFelt[3], b)
	}

	return
}

func (z *Felt) BiggerModulus() bool {
	if z[3] > qFelt[3] {
		return true
	}
	if z[3] < qFelt[3] {
