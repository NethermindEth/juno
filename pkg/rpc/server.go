...
func NewServer(addr string, client *feeder.Client, abiManager *abi.Manager, stateManager *state.Manager,
	transactionManager *transaction.Manager, blockManager *block.Manager) *Server {
