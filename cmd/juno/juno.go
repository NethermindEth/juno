...
const (
	...
	l1ClientUsage = `L1 client backend. One of "geth" (default; go-ethereum based) or "juno"` +
		` (juno's hand-rolled WebSocket JSON-RPC client). No effect with --disable-l1-verification.`
