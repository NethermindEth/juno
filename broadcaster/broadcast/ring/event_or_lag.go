...
// IsEvent returns true if this contains an event.
func (e *EventOrLag[T]) IsEvent() bool {
	return !e.isLag
}

// IsLag returns true if this contains a lag notification.
...
// This method allocates a *LaggedError when returning an error.
// For zero-allocation, use Lag() which returns a pointer to the embedded field.
