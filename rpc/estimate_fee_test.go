...
func TestEstimateFee(t *testing.T) {
	...
	t.Run("ok with zero values", func(t *testing.T) {
		mockVM.EXPECT().Execute(nil, nil, []*felt.Felt{}, &blockInfo, mockState, n, true, false, true, true).
	...
	t.Run("ok with zero values, skip validate", func(t *testing.T) {
		mockVM.EXPECT().Execute(nil, nil, []*felt.Felt{}, &blockInfo, mockState, n, true, true, true, true).
			Return([]*felt.Felt{}, []*felt.Felt{}, []vm.TransactionTrace{}, nil)
