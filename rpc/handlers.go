...
func (h *Handler) WithTransactionsCache(cache *rpccore.TxnCache) *Handler {
	h.rpcv6Handler.WithTransactionsCache(cache)
	h.rpcv7Handler.WithTransactionsCache(cache)
	h.rpcv8Handler.WithTransactionsCache(cache)
	return h
}
