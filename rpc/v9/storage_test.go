...
func TestStorageAt(t *testing.T) {
	...
	expectedStorage := types.New[felt.Felt](1)
...
func TestStorageProof(t *testing.T) {
	...
	var (
		...
		key         = types.New[felt.Felt](1)
		key2        = types.New[felt.Felt](8)
		noSuchKey   = types.New[felt.Felt](0)
		value       = types.New[felt.Felt](51)
		value2      = types.New[felt.Felt](58)
	...
	t.Run("error whenever block hash is not the latest", func(t *testing.T) {
		blockHash := types.New[felt.Felt](1)
	...
	t.Run("storage trie address exists in a trie", func(t *testing.T) {
		nonce := types.New[felt.Felt](121)
		mockState.EXPECT().ContractNonce(key).Return(nonce, nil).Times(1)
		classHasah := types.New[felt.Felt](1234)
...
func verifyGlobalStateRoot(t *testing.T, globalStateRoot, classRoot, storageRoot *felt.Felt) {
	stateVersion := types.NewFromBytes[felt.Felt]([]byte(`STARKNET_STATE_V0`))
	if classRoot.IsZero() {
