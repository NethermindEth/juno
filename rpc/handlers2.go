...
func New2(bcReader blockchain.Reader, syncReader sync.Reader, virtualMachine vm.VM, version string,
...
func (h *Handler2) WithFilterLimit(limit uint) *Handler2 {
...
func (h *Handler2) WithL1Client(l1Client rpccore.L1Client) *Handler2 {
	h.rpcv8Handler.WithL1Client(l1Client)
	return h
}

func (h *Handler2) WithCallMaxSteps(maxSteps uint64) *Handler2 {
...
func (h *Handler2) WithIDGen(idgen func() uint64) *Handler2 {
...
func (h *Handler2) WithFeeder(feederClient *feeder.Client) *Handler2 {
...
func (h *Handler2) WithGateway(gatewayClient rpccore.Gateway) *Handler2 {
...
func (h *Handler2) MethodsV0_8() ([]jsonrpc.Method, string) { //nolint: funlen
...
func (h *Handler2) MethodsV0_7() ([]jsonrpc.Method, string) { //nolint: funlen
	return []jsonrpc.Method{
		{
			Name:    "starknet_chainId",
			Handler: h.rpcv6Handler.ChainID,
...
func (h *Handler2) MethodsV0_6() ([]jsonrpc.Method, string) { //nolint: funlen
	return []jsonrpc.Method{
		{
			Name:    "starknet_chainId",
			Handler: h.rpcv6Handler.ChainID,
