...
func TestTransactionByHash(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			handler := rpc.New(mockReader, nil, nil, test.network, nil, nil)
...
func TestTransactionReceiptByHash(t *testing.T) {
	t.Run("internal error when returning tx by hash from DB", func(t *testing.T) {
		...
		mockReader := mocks.NewMockReader(mockCtrl)
		handler := rpc.New(mockReader, nil, nil, &utils.Sepolia, nil, nil)
...
func TestLegacyTransactionReceiptByHash(t *testing.T) {
	...
	n := &utils.Mainnet
	mockReader := mocks.NewMockReader(mockCtrl)
	handler := rpc.New(mockReader, nil, nil, n, nil, nil)
...
func TestAddTransaction(t *testing.T) {
	...
	for description, test := range tests {
		t.Run(description, func(t *testing.T) {
			...
			handler := rpc.New(mockReader, nil, nil, n, utils.NewNopZapLogger(), receivedTxFeed)
	...
	for _, test := range tests {
		t.Run(test.network.String(), func(t *testing.T) {
			...
			t.Run("transaction not found in db", func(t *testing.T) {
				...
				for description, notFoundTest := range notFoundTests {
					t.Run(description, func(t *testing.T) {
						...
						handler := rpc.New(mockReader, syncReader, nil, test.network, nil, nil)
			...
			t.Run("transaction not found in db and feeder", func(t *testing.T) {
				...
				mockReader.EXPECT().HeadsHeader().Return(nil, db.ErrKeyNotFound)
				handler := rpc.New(mockReader, syncReader, nil, test.network, nil, nil).WithFeeder(client)
...
func TestSubmittedTransactionsCache(t *testing.T) {
	...
	t.Run("transaction not found in db and feeder but found in cache", func(t *testing.T) {
		...
		handler := rpc.New(mockReader, mockSyncReader, nil, &utils.Integration, nil, testReceivedTxFeed).
			WithFeeder(client).
