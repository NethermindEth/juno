...
func TestPendingDataWrapper_PendingData(t *testing.T) {
	...
	t.Run("Returns pending data when valid", func(t *testing.T) {
		...
		t.Run("with pre-confirmed block - returns placeholder pending block", func(t *testing.T) {
...
func TestPendingDataWrapper_PendingState(t *testing.T) {
	...
	t.Run("Returns pending state from sync reader", func(t *testing.T) {
	...
	t.Run("Returns latest state when block is nil", func(t *testing.T) {
