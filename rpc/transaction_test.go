...
func TestTransactionReceiptByHashV0_6(t *testing.T) {
	...
	t.Run("reverted", func(t *testing.T) {
		expected := `{
			"type":"INVOKE",
			"transaction_hash":"0xccd396d42a911917c510808d372b58ba937168b19e1254ac12aabe8f0db6b5",
			"actual_fee":{"amount":"0x9bd5966b4619","unit":"WEI"},
			"execution_status":"REVERTED",
			"finality_status":"ACCEPTED_ON_L2",
			"block_hash":"0x852225462ef12fe1955e473beb93877a8c9723650c56a13888057e2af184d3",
			"block_number":19957,
			"messages_sent":[],
			...
			"revert_reason":"Error in the called contract (0x037a10f2808c05f4a328bdac9a9344358547ae4676ebddc005e24ff887b188fd):\nError at pc=0:4273:\nGot an exception while executing a hint: Custom Hint Error: Execution failed. Failure reason: 0x54696d657374616d7020697320696e2074686520667574757265 ('Timestamp is in the future').\nCairo traceback (most recent call last):\nUnknown location (pc=0:67)\nUnknown location (pc=0:1997)\nUnknown location (pc=0:2727)\nUnknown location (pc=0:3582)\n",
			"execution_resources":{"steps":16849,"pedersen_builtin_applications":16,"range_check_builtin_applications":174,"ec_op_builtin_applications":3}
		}`
	...
	t.Run("v3 tx", func(t *testing.T) {
		expected := `{
			"type":"INVOKE",
			"transaction_hash":"0x740991ac8893aaf8b4feffd127782b41faa5ee51367b485334a63b24b1ac9f4",
			"actual_fee":{"amount":"0x5e5000e0053f4","unit":"FRI"},
			"execution_status":"SUCCEEDED",
			"finality_status":"ACCEPTED_ON_L2",
			"block_hash":"0x852225462ef12fe1955e473beb93877a8c9723650c56a13888057e2af184d3",
			"block_number":19957,
			"messages_sent":[],
			"events":[{"from_address":"0x4718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d","keys":["0x99cd8bde557814842a3121e8ddfd433a539b8c9f14bf31ebf108d12e6196e9","0x35acd6dd6c5045d18ca6d0192af46b335a5402c02d41f46e4e77ea2c951d9a3","0x1176a1bd84444c89232ec27754698e5d2e7e1a7f1539f12027f28b23ec9f3d8"],"data":["0x5e5000e0053f4","0x0"]}],
			"execution_resources":{"steps":5942,"pedersen_builtin_applications":16,"range_check_builtin_applications":145,"ec_op_builtin_applications":3}
		}`

		integClient := feeder.NewTestClient(t, &utils.Sepolia)
		integGw := adaptfeeder.New(integClient)

		block, err := integGw.BlockByNumber(context.Background(), 19957)
		require.NoError(t, err)
...
func TestTransactionReceiptByHash(t *testing.T) {
	...
	t.Run("v3 tx", func(t *testing.T) {
		expected := `{
			...
			"events":[{"from_address":"0x4718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d","keys":["0x99cd8bde557814842a3121e8ddfd433a539b8c9f14bf31ebf108d12e6196e9","0x35acd6dd6c5045d18ca6d0192af46b335a5402c02d41f46e4e77ea2c951d9a3","0x1176a1bd84444c89232ec27754698e5d2e7e1a7f1539f12027f28b23ec9f3d8"],"data":["0x5e5000e0053f4","0x0"]}],
			"execution_resources": {
				"steps":5942,"pedersen_builtin_applications":16,"range_check_builtin_applications":145,"ec_op_builtin_applications":3,
				"data_availability": {
					"l1_gas":0,
					"l1_data_gas":0
				}
