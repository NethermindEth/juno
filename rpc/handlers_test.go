...
type txGwReader struct {
	*blockchain.Blockchain
	gw starknetdata.StarknetData
}

func (r *txGwReader) GetTransactionByHash(hash *felt.Felt) (transaction core.Transaction, err error) {
...
func TestGetTransactionByHash(t *testing.T) {
	...
	handler := rpc.NewHandler(&txGwReader{nil, mainnetGw}, nil)
