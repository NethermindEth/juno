...
func TestTraceTransaction(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute([]core.Transaction{tx}, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, header.SequencerAddress, nil, utils.MAINNET, []*felt.Felt{}, false).Return(nil, []json.RawMessage{vmTrace}, nil)
...
func TestSimulateTransactions(t *testing.T) {
	...
	t.Run("ok with zero values", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute(nil, nil, uint64(0), uint64(0), sequencerAddress, mockState, network, []*felt.Felt{}, true).
...
func TestTraceBlockTransactions(t *testing.T) {
	...
	t.Run("pending block", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute(block.Transactions, []core.Class{declaredClass.Class}, height+1, header.Timestamp, sequencerAddress,
			state, network, paidL1Fees, false).Return(nil, []json.RawMessage{vmTrace, vmTrace}, nil)
	...
	t.Run("regular block", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute([]core.Transaction{tx}, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, header.SequencerAddress, nil, network, []*felt.Felt{}, false).Return(nil, []json.RawMessage{vmTrace}, nil)
