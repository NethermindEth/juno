...
func TestTransactionReceiptByHash(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"with contract addr": {
			...
			expected: `{
					...
					"execution_resources":{"steps":"0x1d","memory_holes":"0x0","pedersen_builtin_applications":"0x0","range_check_builtin_applications":"0x0","bitwise_builtin_applications":"0x0","ecdsa_builtin_applications":"0x0","ec_op_builtin_applications":"0x0","keccak_builtin_applications":"0x0","poseidon_builtin_applications":"0x0"}
				}`,
		},
		"without contract addr": {
			...
			expected: `{
					...
					"events": [],
					"execution_resources":{"steps":"0x1f","memory_holes":"0x0","pedersen_builtin_applications":"0x0","range_check_builtin_applications":"0x0","bitwise_builtin_applications":"0x0","ecdsa_builtin_applications":"0x0","ec_op_builtin_applications":"0x0","keccak_builtin_applications":"0x0","poseidon_builtin_applications":"0x0"}
				}`,
		},
	}
	for name, test := range tests {
	...
	t.Run("reverted", func(t *testing.T) {
		expected := `{
			...
			"execution_resources":{"steps":"0x0","memory_holes":"0x0","pedersen_builtin_applications":"0x0","range_check_builtin_applications":"0x0","bitwise_builtin_applications":"0x0","ecdsa_builtin_applications":"0x0","ec_op_builtin_applications":"0x0","keccak_builtin_applications":"0x0","poseidon_builtin_applications":"0x0"}
		}`
...
func TestTraceTransaction(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute([]core.Transaction{tx}, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, header.SequencerAddress,
			nil, utils.Mainnet, []*felt.Felt{}, false, false, gomock.Any(), false).Return(nil, []json.RawMessage{vmTrace}, nil)
...
func TestTraceBlockTransactions(t *testing.T) {
	...
	t.Run("pending block", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute(block.Transactions, []core.Class{declaredClass.Class}, height+1, header.Timestamp, sequencerAddress,
			state, network, paidL1Fees, false, false, header.GasPrice, false).Return(nil, []json.RawMessage{vmTrace, vmTrace}, nil)
	...
	t.Run("regular block", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute([]core.Transaction{tx}, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, header.SequencerAddress,
			nil, network, []*felt.Felt{}, false, false, header.GasPrice, false).Return(nil, []json.RawMessage{vmTrace}, nil)
