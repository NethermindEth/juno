...
func (s *Synchronizer) PendingState() (core.StateReader, func() error, error) {
	...
	return NewPendingState(pending.GetStateUpdate().StateDiff, pending.GetNewClasses(), core.NewState(txn, nil)), noop, nil
}
...
func (s *Synchronizer) PendingStateBeforeIndex(index int) (core.StateReader, func() error, error) {
	...
	return NewPendingState(&stateDiff, pending.GetNewClasses(), core.NewState(txn, nil)), noop, nil
}
