...
func New(cfg *Config, version string, logLevel *utils.LogLevel) (*Node, error) { //nolint:gocyclo,funlen
	...
	if cfg.Metrics {
		...
		jsonrpcServerV08.WithListener(makeRPCMetrics(pathV08))
		jsonrpcServerV07.WithListener(makeRPCMetrics(pathV07))
		jsonrpcServerV06.WithListener(makeRPCMetrics(pathV06))
