...
func (tvm *ThrottledVM) Call(callInfo *vm.CallInfo, blockInfo *vm.BlockInfo, state state.StateReader,
...
func (tvm *ThrottledVM) Execute(txns []core.Transaction, declaredClasses []core.Class, paidFeesOnL1 []*felt.Felt,
	blockInfo *vm.BlockInfo, state state.StateReader, network *utils.Network, skipChargeFee, skipValidate, errOnRevert, errStack bool,
