...
type VMCallRequest struct {
	...
	CallerAddress   []byte                   `protobuf:"bytes,5,opt,name=caller_address,json=callerAddress,proto3" json:"caller_address,omitempty"`
	Signature       []byte                   `protobuf:"bytes,6,opt,name=signature,proto3" json:"signature,omitempty"`
	BlockInfo       *VMCallRequest_BlockInfo `protobuf:"bytes,7,opt,name=block_info,json=blockInfo,proto3" json:"block_info,omitempty"`
}
...
func (x *VMCallRequest) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *VMCallRequest) GetBlockInfo() *VMCallRequest_BlockInfo {
	if x != nil {
		return x.BlockInfo
	}
	return nil
...
type VMCallRequest_BlockInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SequencerAddress uint64 `protobuf:"varint,4,opt,name=sequencer_address,json=sequencerAddress,proto3" json:"sequencer_address,omitempty"`
}

func (x *VMCallRequest_BlockInfo) Reset() {
	*x = VMCallRequest_BlockInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *VMCallRequest_BlockInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VMCallRequest_BlockInfo) ProtoMessage() {}

func (x *VMCallRequest_BlockInfo) ProtoReflect() protoreflect.Message {
	mi := &file_vm_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VMCallRequest_BlockInfo.ProtoReflect.Descriptor instead.
func (*VMCallRequest_BlockInfo) Descriptor() ([]byte, []int) {
	return file_vm_proto_rawDescGZIP(), []int{2, 0}
}

func (x *VMCallRequest_BlockInfo) GetNumber() uint64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *VMCallRequest_BlockInfo) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *VMCallRequest_BlockInfo) GetGasPrice() uint64 {
	if x != nil {
		return x.GasPrice
	}
	return 0
...
func (x *VMCallRequest_BlockInfo) GetSequencerAddress() uint64 {
	if x != nil {
...
var file_vm_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x92, 0x03, 0x0a, 0x0d, 0x56, 0x4d,
	0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x72,
	...
	0x61, 0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x65,
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x73, 0x65,
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x64, 0x61,
	0x74, 0x61, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x63, 0x61, 0x6c, 0x6c,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x37, 0x0a, 0x0a, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x56, 0x4d,
	0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f,
	0x1a, 0x8b, 0x01, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x16,
	...
	,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32,
...
var file_vm_proto_goTypes = []interface{}{
	...
	(*VMCallRequest_BlockInfo)(nil), // 4: VMCallRequest.BlockInfo
}
var file_vm_proto_depIdxs = []int32{
	4, // 0: VMCallRequest.block_info:type_name -> VMCallRequest.BlockInfo
	0, // 1: StorageAdapter.GetValue:input_type -> GetValueRequest
	2, // 2: VM.Call:input_type -> VMCallRequest
	1, // 3: StorageAdapter.GetValue:output_type -> GetValueResponse
	3, // 4: VM.Call:output_type -> VMCallResponse
...
func file_vm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vm_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VMCallRequest_BlockInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
