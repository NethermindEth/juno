...
func TestNew(t *testing.T) {
	...
	t.Run("empty blockchain's head is nil", func(t *testing.T) {
		chain := blockchain.New(pebble.NewMemTest(), core.MAINNET, log)
		assert.Equal(t, core.MAINNET, chain.Network())
		b, err := chain.Head()
		assert.Nil(t, b)
	...
	t.Run("non-empty blockchain gets head from db", func(t *testing.T) {
		...
		chain := blockchain.New(testDB, core.MAINNET, log)
...
func TestHeight(t *testing.T) {
	...
	t.Run("return nil if blockchain is empty", func(t *testing.T) {
		chain := blockchain.New(pebble.NewMemTest(), core.GOERLI, log)
		_, err := chain.Height()
		assert.Error(t, err)
	})
...
func TestBlockByNumberAndHash(t *testing.T) {
	chain := blockchain.New(pebble.NewMemTest(), core.GOERLI, utils.NewNopZapLogger())
...
func TestVerifyBlock(t *testing.T) {
	...
	chain := blockchain.New(pebble.NewMemTest(), core.MAINNET, utils.NewNopZapLogger())
