...
func TestBlockHeaderV013Unmarshal(t *testing.T) {
	...
	require.Equal(
		t,
		utils.HexToFelt(t, "0x50e864db6b81ce69fbeb70e6a7284ee2febbb9a2e707415de7adab83525e9cd"),
		block.Hash,
	)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x39dfc381180356734085e2d70b640e153c241c7f65936cacbdff9fad84bbc0c"),
		block.ParentHash,
	)
	require.Equal(t, uint64(319132), block.Number)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x2a6b9a8b60e1de80dc50e6b704b415a38e8fd03d82244cec92cbff0821a8975"),
		block.StateRoot,
	)
...
func TestBlockHeaderV0131Unmarshal(t *testing.T) {
	...
	require.Equal(
		t,
		utils.HexToFelt(t, "0x8ab8117e952f95efd96de0bc66dc6f13fe68dfda14b95fe1972759dee283a8"),
		block.Hash,
	)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x13367121d0b7e34a9b10c8a5a1c269811cd9afc3ce680c88888f1a22d2f017a"),
		block.TransactionCommitment,
	)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x1090dd2ab2aa22bd5fc5a59d3b1394d54461bb2a80156c4b2c2622d2c474ca2"),
...
func TestBlockHeaderv0132Unmarshal(t *testing.T) {
	...
	require.Equal(
		t,
		utils.HexToFelt(t, "0x1ea2a9cfa3df5297d58c0a04d09d276bc68d40fe64701305bbe2ed8f417e869"),
		block.Hash,
	)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x77140bef51bbb4d1932f17cc5081825ff18465a1df4440ca0429a4fa80f1dc5"),
		block.ParentHash,
	)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x6f12628d21a8df7f158b631d801fc0dd20034b9e22eca255bddc0c1c1bc283f"),
		block.ReceiptCommitment,
	)
	require.Equal(
		t,
		utils.HexToFelt(t, "0x23587c54d590b57b8e25acbf1e1a422eb4cd104e95ee4a681021a6bb7456afa"),
