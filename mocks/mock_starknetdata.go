...
func (m *MockStarknetData) PreConfirmedBlockLatest(ctx context.Context, blockIdentifier starknet.BlockIdentifier, knownTransactionCount uint64) (starknet.PreConfirmedUpdate, uint64, error) {
	m.ctrl.T.Helper()
