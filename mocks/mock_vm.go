...
func (m *MockVM) Call(callInfo *vm.CallInfo, blockInfo *vm.BlockInfo, state vm.StateReader, network *utils.Network, maxSteps uint64, sierraVersion string, structuredErrStack, returnStateDiff bool) (vm.CallResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockVM) Execute(txns []core.Transaction, declaredClasses []core.Class, paidFeesOnL1 []*felt.Felt, blockInfo *vm.BlockInfo, state vm.StateReader, network *utils.Network, skipChargeFee, skipValidate, errOnRevert, errStack bool) (vm.ExecutionResults, error) {
	m.ctrl.T.Helper()
