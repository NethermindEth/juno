...
use blockifier::{
    execution::contract_class::{ClassInfo as BlockifierClassInfo, ContractClassV0, ContractClassV1,ContractClass},
    state::{state_api::{StateReader, StateResult,State}, errors::StateError, cached_state::CommitmentStateDiff,}
};
...
impl State for JunoState {
    fn add_visited_pcs(&mut self, _: ClassHash, _: &HashSet<usize>) { todo!() }
