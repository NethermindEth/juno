...
impl State for JunoStateReader {
    ...
    fn set_class_hash_at(
        ...
        state_read_err(unsafe { JunoStateSetClassHash(self.handle, addr.as_ptr(), class_hash.as_ptr()) })
    }
    ...
    fn set_compiled_class_hash(
        ...
        state_read_err(unsafe { JunoStateSetClassHash(self.handle, class_hash_bytes.as_ptr(), compiled_class_hash_bytes.as_ptr()) })
    }
