...
//
// #cgo vm_debug,!darwin LDFLAGS:  -L./rust/target/debug -ljuno_starknet_rs -lm -ldl
// #cgo !vm_debug,!darwin LDFLAGS: -L./rust/target/release -ljuno_starknet_rs -lm -ldl
// #cgo vm_debug,darwin LDFLAGS:  -L./rust/target/debug -ljuno_starknet_rs -lm -ldl -framework Foundation -framework SystemConfiguration
// #cgo !vm_debug,darwin LDFLAGS: -L./rust/target/release -ljuno_starknet_rs -lm -ldl -framework Foundation -framework SystemConfiguration
import "C"
