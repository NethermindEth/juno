...
We are working on the space on disk, is a well-known problem which we are working at, and we are planning to release a
new version of Juno soon.
...
this space, you can run it using an SSD, just should ensure that the property `db_path` points to the external SSD:
