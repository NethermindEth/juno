---
title : Contribution to Juno
---

# Contributions Guidelines

See [Engineering Guidelines](https://www.notion.so/Engineering-Guidelines-f916deb46ee242a0afaf36cc436e4c73) for more details

## 1. Create a branch off of `main`

Name the branch with a useful name. Ideally, read [this](https://stackoverflow.com/questions/273695/what-are-some-examples-of-commonly-used-practices-for-naming-git-branches) link.
