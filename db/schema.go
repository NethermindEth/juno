...
func ContractStorageRootKey(stateCommitment, contractCommitment *felt.Felt) []byte {
	return ContractStorageRoot.Key(stateCommitment.Marshal(), contractCommitment.Marshal())
}
