...
func New2(bc *blockchain.Blockchain2, h host.Host, n *utils.Network, log utils.SimpleLogger) *Service2 {
	return &Service2{
		host:       h,
		network:    n,
		blockchain: bc,
...
func (s *Service2) Run(ctx context.Context) {
...
func (s *Service2) getNextHeight() (int, error) {
...
func (s *Service2) processBlock(ctx context.Context, blockNumber uint64) error {
...
func (s *Service2) logError(msg string, err error) {
...
//nolint:gocyclo
func (s *Service2) processSpecBlockParts(
...
func (s *Service2) adaptAndSanityCheckBlock(ctx context.Context, header *gen.SignedBlockHeader, contractDiffs []*gen.ContractDiff,
	...
	go func() {
		...
		default:
			...
			stateDiff := p2p2core.AdaptStateDiff2(stateReader, contractDiffs, classes)
...
func (s *Service2) genHeadersAndSigs(ctx context.Context, blockNumber uint64) (<-chan specBlockHeaderAndSigs, error) {
...
func (s *Service2) genClasses(ctx context.Context, blockNumber uint64) (<-chan specClasses, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *Service2) genStateDiffs(ctx context.Context, blockNumber uint64) (<-chan specContractDiffs, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *Service2) genEvents(ctx context.Context, blockNumber uint64) (<-chan specEvents, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *Service2) genTransactions(ctx context.Context, blockNumber uint64) (<-chan specTxWithReceipts, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *Service2) randomPeer() peer.ID {
...
func (s *Service2) randomPeerStream(ctx context.Context, pids ...protocol.ID) (network.Stream, error) {
...
func (s *Service2) removePeer(id peer.ID) {
	s.log.Debugw("Removing peer", "peerID", id)
	s.host.Peerstore().RemovePeer(id)
	s.host.Peerstore().ClearAddrs(id)
}

func (s *Service2) createIteratorForBlock(blockNumber uint64) *gen.Iteration {
...
func (s *Service2) WithListener(l junoSync.EventListener) {
	s.listener = l
}
