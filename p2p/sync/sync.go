...
func (s *BlockFetcher) genHeadersAndSigs(ctx context.Context, blockNumber uint64) (<-chan specBlockHeaderAndSigs, error) {
...
func (s *BlockFetcher) genClasses(ctx context.Context, blockNumber uint64) (<-chan specClasses, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *BlockFetcher) genStateDiffs(ctx context.Context, blockNumber uint64) (<-chan specContractDiffs, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *BlockFetcher) genEvents(ctx context.Context, blockNumber uint64) (<-chan specEvents, error) {
	it := s.createIteratorForBlock(blockNumber)
...
func (s *BlockFetcher) genTransactions(ctx context.Context, blockNumber uint64) (<-chan specTxWithReceipts, error) {
	it := s.createIteratorForBlock(blockNumber)
