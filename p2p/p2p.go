...
func New(addr, userAgent, bootPeers, privKeyStr string, snNetwork utils.NetworkKnown, log utils.SimpleLogger) (*Service, error) {
	if addr == "" {
...
func NewWithHost(p2phost host.Host, bootPeers string, snNetwork utils.NetworkKnown, log utils.SimpleLogger) (*Service, error) {
...
func makeDHT(p2phost host.Host, snNetwork utils.NetworkKnown, cfgBootPeers string) (*dht.IpfsDHT, error) {
