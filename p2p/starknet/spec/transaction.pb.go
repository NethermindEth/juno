...
type Transaction_InvokeV1 struct {
	...
	ClassHash *Hash             `protobuf:"bytes,4,opt,name=class_hash,json=classHash,proto3" json:"class_hash,omitempty"`
	Calldata  []*Felt252        `protobuf:"bytes,5,rep,name=calldata,proto3" json:"calldata,omitempty"`
	Nonce     *Felt252          `protobuf:"bytes,6,opt,name=nonce,proto3" json:"nonce,omitempty"`
}
...
type Transaction_InvokeV3 struct {
	...
	Nonce       *Felt252          `protobuf:"bytes,12,opt,name=nonce,proto3" json:"nonce,omitempty"`
}
...
var file_p2p_proto_transaction_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0x35, 0x32, 0x52, 0x05, 0x70, 0x61, 0x72, 0x74, 0x73, 0x22, 0x9b, 0x1d, 0x0a, 0x0b,
	...
	0x63, 0x61, 0x6c, 0x6c, 0x64, 0x61, 0x74, 0x61, 0x1a, 0xec, 0x01, 0x0a, 0x08, 0x49, 0x6e, 0x76,
	...
	0x61, 0x6c, 0x6c, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1e, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x46, 0x65, 0x6c, 0x74, 0x32, 0x35, 0x32,
	0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x1a, 0xc2, 0x03, 0x0a, 0x08, 0x49, 0x6e, 0x76, 0x6f,
	...
	0x09, 0x52, 0x09, 0x66, 0x65, 0x65, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x1e, 0x0a, 0x05,
	0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x46, 0x65,
	0x6c, 0x74, 0x32, 0x35, 0x32, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x1a, 0xb3, 0x01, 0x0a,
...
var file_p2p_proto_transaction_proto_depIdxs = []int32{
	...
	17, // 73: Transaction.InvokeV1.nonce:type_name -> Felt252
	21, // 74: Transaction.InvokeV3.sender:type_name -> Address
	17, // 75: Transaction.InvokeV3.max_fee:type_name -> Felt252
	1,  // 76: Transaction.InvokeV3.signature:type_name -> AccountSignature
	22, // 77: Transaction.InvokeV3.class_hash:type_name -> Hash
	17, // 78: Transaction.InvokeV3.calldata:type_name -> Felt252
	0,  // 79: Transaction.InvokeV3.l1_gas:type_name -> ResourceLimits
	0,  // 80: Transaction.InvokeV3.l2_gas:type_name -> ResourceLimits
	17, // 81: Transaction.InvokeV3.tip:type_name -> Felt252
	21, // 82: Transaction.InvokeV3.paymaster:type_name -> Address
	17, // 83: Transaction.InvokeV3.nonce:type_name -> Felt252
	17, // 84: Transaction.L1HandlerV1.nonce:type_name -> Felt252
	21, // 85: Transaction.L1HandlerV1.address:type_name -> Address
	17, // 86: Transaction.L1HandlerV1.entry_point_selector:type_name -> Felt252
	17, // 87: Transaction.L1HandlerV1.calldata:type_name -> Felt252
