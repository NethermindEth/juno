...
var file_p2p_proto_common_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x72, 0x74, 0x22, 0x05, 0x0a, 0x03, 0x46, 0x69, 0x6e, 0x42, 0x31, 0x5a, 0x2f,
...
var (
	file_p2p_proto_common_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	...
	file_p2p_proto_common_proto_goTypes   = []interface{}{
		...
		(*Felt252)(nil),            // 1: Felt252
		(*Hash)(nil),               // 2: Hash
		(*Hashes)(nil),             // 3: Hashes
		(*Address)(nil),            // 4: Address
		(*PeerID)(nil),             // 5: PeerID
		(*ConsensusSignature)(nil), // 6: ConsensusSignature
		(*Merkle)(nil),             // 7: Merkle
...
var file_p2p_proto_common_proto_depIdxs = []int32{
	2, // 0: Hashes.items:type_name -> Hash
	1, // 1: ConsensusSignature.r:type_name -> Felt252
	1, // 2: ConsensusSignature.s:type_name -> Felt252
	2, // 3: Merkle.root:type_name -> Hash
	2, // 4: Patricia.root:type_name -> Hash
	2, // 5: BlockID.header:type_name -> Hash
	2, // 6: Iteration.header:type_name -> Hash
