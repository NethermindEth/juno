...
var (
	file_p2p_proto_common_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
	file_p2p_proto_common_proto_msgTypes  = make([]protoimpl.MessageInfo, 12)
...
func file_p2p_proto_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_p2p_proto_common_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Fin); i {
			case 0:
				return &v.state
			case 1:
