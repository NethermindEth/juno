...
type BlockHeader struct {
	...
	Time             *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=time,proto3" json:"time,omitempty"` // TODO: see if this needs to be Felt252 or can be converted
	...
	StateDiffs       *Merkle                `protobuf:"bytes,6,opt,name=state_diffs,json=stateDiffs,proto3" json:"state_diffs,omitempty"` //  By order of (contract, key), taking last in case of duplicates.
	...
	ProofFact *Hash     `protobuf:"bytes,8,opt,name=proof_fact,json=proofFact,proto3" json:"proof_fact,omitempty"` // for Kth block behind. A hash of the output of the proof
	// The following merkles can be built on the fly while sequencing/validating txs.
	Transactions *Merkle `protobuf:"bytes,9,opt,name=transactions,proto3" json:"transactions,omitempty"` // By order of execution. TBD: required? the client can execute (powerful machine)
	// and match state diff
	Events          *Merkle  `protobuf:"bytes,10,opt,name=events,proto3" json:"events,omitempty"`                                          // By order of issuance. TBD: in receipts?
	Receipts        *Merkle  `protobuf:"bytes,11,opt,name=receipts,proto3" json:"receipts,omitempty"`                                      // By order of issuance.
	ProtocolVersion string   `protobuf:"bytes,12,opt,name=protocol_version,json=protocolVersion,proto3" json:"protocol_version,omitempty"` // Starknet version
	ExtraData       *Felt252 `protobuf:"bytes,13,opt,name=extra_data,json=extraData,proto3" json:"extra_data,omitempty"`
	GasPrice        *Felt252 `protobuf:"bytes,14,opt,name=gas_price,json=gasPrice,proto3" json:"gas_price,omitempty"`
}
...
func (x *BlockHeader) GetHash() *Hash {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *BlockHeader) GetExtraData() *Felt252 {
	if x != nil {
		return x.ExtraData
	}
	return nil
...
type BlockBodiesResponse struct {
	...
	//	*BlockBodiesResponse_Transactions
	//	*BlockBodiesResponse_Receipts
...
func (x *BlockBodiesResponse) GetTransactions() *Transactions {
	if x, ok := x.GetBodyMessage().(*BlockBodiesResponse_Transactions); ok {
		return x.Transactions
	}
	return nil
}

func (x *BlockBodiesResponse) GetReceipts() *Receipts {
	if x, ok := x.GetBodyMessage().(*BlockBodiesResponse_Receipts); ok {
		return x.Receipts
	}
	return nil
}
...
type BlockBodiesResponse_Transactions struct {
	Transactions *Transactions `protobuf:"bytes,6,opt,name=transactions,proto3,oneof"`
}

type BlockBodiesResponse_Receipts struct {
	Receipts *Receipts `protobuf:"bytes,7,opt,name=receipts,proto3,oneof"`
}

type BlockBodiesResponse_Fin struct {
	Fin *Fin `protobuf:"bytes,8,opt,name=fin,proto3,oneof"`
}
...
func (*BlockBodiesResponse_Transactions) isBlockBodiesResponse_BodyMessage() {}

func (*BlockBodiesResponse_Receipts) isBlockBodiesResponse_BodyMessage() {}
...
var file_p2p_proto_block_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x45, 0x0a, 0x14, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x2d, 0x0a, 0x04, 0x70, 0x61, 0x72, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x50, 0x61, 0x72, 0x74, 0x52, 0x04, 0x70, 0x61, 0x72, 0x74, 0x22, 0x3e,
	0x0a, 0x12, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x6f, 0x64, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71,
	...
	,
...
var file_p2p_proto_block_proto_goTypes = []interface{}{
	...
	(*Transactions)(nil),              // 22: Transactions
	(*Receipts)(nil),                  // 23: Receipts
}
var file_p2p_proto_block_proto_depIdxs = []int32{
	...
	12, // 2: BlockHeader.hash:type_name -> Hash
	12, // 3: BlockHeader.parent_hash:type_name -> Hash
	13, // 4: BlockHeader.time:type_name -> google.protobuf.Timestamp
	14, // 5: BlockHeader.sequencer_address:type_name -> Address
	15, // 6: BlockHeader.state_diffs:type_name -> Merkle
	16, // 7: BlockHeader.state:type_name -> Patricia
	12, // 8: BlockHeader.proof_fact:type_name -> Hash
	15, // 9: BlockHeader.transactions:type_name -> Merkle
	15, // 10: BlockHeader.events:type_name -> Merkle
	15, // 11: BlockHeader.receipts:type_name -> Merkle
	17, // 12: BlockHeader.extra_data:type_name -> Felt252
	17, // 13: BlockHeader.gas_price:type_name -> Felt252
	10, // 14: NewBlock.id:type_name -> BlockID
	7,  // 15: NewBlock.header:type_name -> BlockHeadersResponse
	9,  // 16: NewBlock.body:type_name -> BlockBodiesResponse
	18, // 17: BlockHeadersRequest.iteration:type_name -> Iteration
	1,  // 18: BlockHeadersResponsePart.header:type_name -> BlockHeader
	0,  // 19: BlockHeadersResponsePart.signatures:type_name -> Signatures
	19, // 20: BlockHeadersResponsePart.fin:type_name -> Fin
	6,  // 21: BlockHeadersResponse.part:type_name -> BlockHeadersResponsePart
	18, // 22: BlockBodiesRequest.iteration:type_name -> Iteration
	10, // 23: BlockBodiesResponse.id:type_name -> BlockID
	20, // 24: BlockBodiesResponse.diff:type_name -> StateDiff
	21, // 25: BlockBodiesResponse.classes:type_name -> Classes
	2,  // 26: BlockBodiesResponse.proof:type_name -> BlockProof
	22, // 27: BlockBodiesResponse.transactions:type_name -> Transactions
	23, // 28: BlockBodiesResponse.receipts:type_name -> Receipts
	19, // 29: BlockBodiesResponse.fin:type_name -> Fin
...
func file_p2p_proto_block_proto_init() {
	...
	file_p2p_proto_block_proto_msgTypes[9].OneofWrappers = []interface{}{
		...
		(*BlockBodiesResponse_Transactions)(nil),
		(*BlockBodiesResponse_Receipts)(nil),
