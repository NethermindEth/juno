...
func (x *Classes) Reset() {
	*x = Classes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_p2p_proto_class_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Classes) Descriptor() ([]byte, []int) {
	return file_p2p_proto_class_proto_rawDescGZIP(), []int{8}
}
...
var file_p2p_proto_class_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x43, 0x0a, 0x07, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06,
...
func file_p2p_proto_class_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_p2p_proto_class_proto_msgTypes[8].Exporter = func(v any, i int) any {
