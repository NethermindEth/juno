...
func file_p2p_proto_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_p2p_proto_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
		...
		file_p2p_proto_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_p2p_proto_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
