...
type Service2 struct {
	...
	handler *p2pPeers.Handler2
	log     utils.SimpleLogger

	dht    *dht.IpfsDHT
	pubsub *pubsub.PubSub

	synchroniser *p2pSync.Service2
...
func New2(addr, publicAddr, version, peers, privKeyStr string, feederNode bool, bc *blockchain.Blockchain2, snNetwork *utils.Network,
...
func NewWithHost2(p2phost host.Host, peers string, feederNode bool, bc *blockchain.Blockchain2, snNetwork *utils.Network,
	log utils.SimpleLogger, database db.KeyValueStore,
) (*Service2, error) {
	var (
	...
	synchroniser := p2pSync.New2(bc, p2phost, snNetwork, log)
	s := &Service2{
		...
		handler:      p2pPeers.NewHandler2(bc, log),
		database:     database,
	}
	return s, nil
}
...
func (s *Service2) setProtocolHandlers() {
...
func (s *Service2) callAndLogErr(f func() error, msg string) {
	err := f()
	if err != nil {
...
func (s *Service2) ListenAddrs() ([]multiaddr.Multiaddr, error) {
...
func (s *Service2) NewStream(ctx context.Context, pids ...protocol.ID) (network.Stream, error) {
...
func (s *Service2) SetProtocolHandler(pid protocol.ID, handler func(network.Stream)) {
