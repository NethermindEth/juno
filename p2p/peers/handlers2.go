...
func NewHandler2(bcReader blockchain.Reader2, log utils.SimpleLogger) *Handler2 {
...
func (h *Handler2) HeadersHandler(stream network.Stream) {
	streamHandler(h.ctx, &h.wg, stream, h.onHeadersRequest, h.log)
}

func (h *Handler2) EventsHandler(stream network.Stream) {
	streamHandler(h.ctx, &h.wg, stream, h.onEventsRequest, h.log)
}

func (h *Handler2) TransactionsHandler(stream network.Stream) {
	streamHandler(h.ctx, &h.wg, stream, h.onTransactionsRequest, h.log)
}

func (h *Handler2) ClassesHandler(stream network.Stream) {
	streamHandler(h.ctx, &h.wg, stream, h.onClassesRequest, h.log)
}

func (h *Handler2) StateDiffHandler(stream network.Stream) {
	streamHandler(h.ctx, &h.wg, stream, h.onStateDiffRequest, h.log)
}

func (h *Handler2) onHeadersRequest(req *gen.BlockHeadersRequest) (iter.Seq[proto.Message], error) {
...
func (h *Handler2) onEventsRequest(req *gen.EventsRequest) (iter.Seq[proto.Message], error) {
...
func (h *Handler2) onTransactionsRequest(req *gen.TransactionsRequest) (iter.Seq[proto.Message], error) {
...
//nolint:gocyclo
func (h *Handler2) onStateDiffRequest(req *gen.StateDiffsRequest) (iter.Seq[proto.Message], error) {
...
func (h *Handler2) onClassesRequest(req *gen.ClassesRequest) (iter.Seq[proto.Message], error) {
...
func (h *Handler2) processIterationRequest(iteration *gen.Iteration, finMsg proto.Message,
...
func (h *Handler2) processIterationRequestMulti(iteration *gen.Iteration, finMsg proto.Message,
...
func (h *Handler2) newIterator(it *gen.Iteration) (*iterator2, error) {
	...
	case *gen.Iteration_BlockNumber:
		return newIteratorByNumber2(h.bcReader, v.BlockNumber, it.Limit, it.Step, forward)
	case *gen.Iteration_Header:
		return newIteratorByHash2(h.bcReader, p2p2core.AdaptHash(v.Header), it.Limit, it.Step, forward)
	default:
		return nil, fmt.Errorf("unsupported iteration start type %T", v)
	}
}

func (h *Handler2) Close() {
