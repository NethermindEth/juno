...
func (b *Builder) ValidateAgainstPendingState(userTxn *mempool.BroadcastedTransaction) error {
	...
	blockInfo := vm.BlockInfo{
		Header: pendingBlock.Block.Header,
	}
	paidFeesOnL1 := []*felt.Felt{}
	_, _, _, err = b.vm.Execute([]core.Transaction{userTxn.Transaction}, declaredClasses, paidFeesOnL1, &blockInfo, state, b.bc.Network(),
...
func (b *Builder) runTxn(txn *mempool.BroadcastedTransaction) error {
	...
	paidFeesOnL1 := []*felt.Felt{}
	fee, _, trace, err := b.vm.Execute([]core.Transaction{txn.Transaction}, classes, paidFeesOnL1, &blockInfo, state, b.bc.Network(),
		false, false, false, false)
	if err != nil {
		return err
	}
