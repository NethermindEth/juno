...
The text you provided is already grammatically correct and contains no typographical errors. Therefore, no changes are necessary:
...
Juno can synchronize Starknet's state from other full nodes with the aim of decentralizing Starknet by removing the dependency on the centralized sequencer.
...
•   Full Node: complete verification of the Starknet state along with transaction execution.

•   Sequencer: secure the network by taking part in the Layer 2 (L2) consensus mechanism.

</details>

## 👍 Contribute

We welcome PRs from external contributors and would love to help you get up to speed. Let us know you're interested on the [Discord server](https://discord.gg/TcHbSZ9ATd), and we can discuss good first issues. There are also many other ways to contribute. Here are some ideas:
