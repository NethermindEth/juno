...
func (pr *PerformanceReporter) writeHeaders() error {
	...
	if pr.useNewState {
		...
		headers = []string{
			...
			"allRegisterDeployedContractsTime",
			"allUpdateContractsTime",
			"allReplaceContractsTime",
			"allUpdateContractNoncesTime",
			"allUpdateContractsStorageTime",
			"allCheckContractsDeployedTime",
...
func (pr *PerformanceReporter) writeReport() error {
	...
	if pr.useNewState {
		...
		record = []string{
			...
			fmt.Sprintf("%d", pr.metrics["allRegisterDeployedContractsTime"]),
			fmt.Sprintf("%d", pr.metrics["allUpdateContractsTime"]),
			fmt.Sprintf("%d", pr.metrics["allReplaceContractsTime"]),
			fmt.Sprintf("%d", pr.metrics["allUpdateContractNoncesTime"]),
			fmt.Sprintf("%d", pr.metrics["allUpdateContractsStorageTime"]),
			fmt.Sprintf("%d", pr.metrics["allCheckContractsDeployedTime"]),
