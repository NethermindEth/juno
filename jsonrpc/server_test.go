...
func TestHandle(t *testing.T) {
  ...
  {"jsonrpc": "2.0", "method"
			...
			res: `{"jsonrpc":"2.0","error":{"code":-32700,"message":"Parse error","data":"]\n^\nunexpected ']', expected ':' [line 4, column 1]"},"id":null}`,
		},
