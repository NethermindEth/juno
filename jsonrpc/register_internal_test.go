...
// Dispatch) and invoke the Dispatch closure directly to verify ctx
// threading, header propagation, and the user-fn return path.
// ---------------------------------------------------------------------
...
func TestRegister_AllVariants_ParamStructType(t *testing.T) {
